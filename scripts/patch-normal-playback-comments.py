...
replace_once(
    'frontend/src/components/video/previewFrameEffects.ts',
    """ * effects; authored scene effects remain the free-running/fallback\n * path only when the top-level canonical frame itself is unavailable.\n""",
    """ * effects; authored scene effects remain the explicit fallback path only when\n * the top-level canonical frame itself is unavailable.\n""",
