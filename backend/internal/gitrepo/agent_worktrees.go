...
// Promote revalidates the exact review digest and applies that patch into a
// clean configured base worktree. It does not stage, commit, fetch, push, or
// merge; the existing guarded Git tools remain authoritative for publication.
