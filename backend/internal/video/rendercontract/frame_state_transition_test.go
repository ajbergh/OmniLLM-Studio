...
func TestVisualFrameStateTransitionPaintDebtIsFrameScoped(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "out-transition-paint-after-between-end", frameIndex: 65, wantUnresolved: []string{}, wantActiveID: "slide-out", wantOwnerPresent: true, wantOwnerAuthority: true, wantLayerCount: 2},
