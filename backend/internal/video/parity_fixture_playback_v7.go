...
func PlaybackCanonicalParityFixtureV7() (TimelineDocument, []ParityFixtureAsset, []PlaybackParityCase) {
	...
	unsupportedEllipse := TimelineClip{
		...
		// deterministic media generated by cmd/video-parity-fixture. The prior
		// 26.8-second placement correctly proved shape fallback but exhausted the
		// shared WAV, causing the unchanged playback clock gate to fail for an
		// unrelated harness reason.
		StartMS:    1000,
		DurationMS: 590,
		TrimOutMS:  590,
		Transform: map[string]any{
	...
	cases = append(cases,
		...
		PlaybackParityCase{
			Name: "unsupported-ellipse-fallback", FrameIndex: 30, ObserveMS: 300,
