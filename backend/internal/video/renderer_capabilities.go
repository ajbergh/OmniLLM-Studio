...
func FFmpegRendererCapabilities() RendererCapabilities {
	return RendererCapabilities{
		...
		Features: []RendererFeatureSupport{
			...
			{Feature: RendererFeatureKeyframes, Label: "Keyframes", Supported: true, Partial: true, Notes: "Position (x/y) and volume keyframes render with linear interpolation; scale, rotation, and opacity keyframes — and easing curves — are preview-only."},
