...
For sports_lookup, normalize common leagues to MLB, NFL, NBA, WNBA, NHL, NCAAF, NCAAMB, NCAAWB, EPL, MLS, UCL, LALIGA, BUNDESLIGA, SERIEA, LIGUE1, IPL, F1, NASCAR, PGA, or ATP.`, now.Format(time.RFC3339), mode, strings.Join(routes, ", "))
}
