...
describe('media source timing', () => {
  ...
  it('nudges deterministic video seeks beyond a millisecond-quantized frame PTS while staying inside tolerance', () => {
    ...
    // VP9 WebM generated by the retained fixture uses a 1/1000 time base, so
    // canonical 59/30 must land beyond the muxed 1.967 s PTS rather than below it.
    expect(seekTarget).toBeGreaterThan(1.967);
