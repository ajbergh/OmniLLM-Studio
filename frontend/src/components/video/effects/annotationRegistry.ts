...
export const ANNOTATION_DEFINITIONS: AnnotationDefinition[] = [
  ...
  { kind: 'spotlight', label: 'Spotlight', category: 'focus', exportSupport: 'partial', exportNote: 'Exports as a simplified deterministic focus primitive' },
  { kind: 'ellipse', label: 'Ellipse', category: 'mark', exportSupport: 'partial', exportNote: 'Exports as a simplified deterministic primitive' },
  { kind: 'arrow', label: 'Arrow', category: 'mark', exportSupport: 'partial', exportNote: 'Exports as a simplified deterministic primitive' },
  { kind: 'line', label: 'Line', category: 'mark', exportSupport: 'partial', exportNote: 'Exports as a simplified deterministic primitive' },
  { kind: 'checkmark', label: 'Checkmark', category: 'mark', exportSupport: 'partial', exportNote: 'Exports as a simplified deterministic glyph' },
  { kind: 'x_mark', label: 'X mark', category: 'mark', exportSupport: 'partial', exportNote: 'Exports as a simplified deterministic glyph' },
  { kind: 'step_marker', label: 'Numbered step', category: 'mark', exportSupport: 'partial', exportNote: 'Exports as a simplified deterministic marker' },
];
