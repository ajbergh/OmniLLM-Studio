> **Archived — superseded review checkpoint.** Later sandbox, browser, and runtime work changed the remediation baseline. Unfinished items confirmed against current code are consolidated in [MASTER_PLAN.md](../../MASTER_PLAN.md).
