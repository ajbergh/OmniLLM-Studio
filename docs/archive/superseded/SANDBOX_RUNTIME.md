> **Archived — superseded.** This platform snapshot predates the shipped Windows and macOS native runtimes. Use [the current runtime status](../../SANDBOX_RUNTIME_CURRENT_2026-08.md).
