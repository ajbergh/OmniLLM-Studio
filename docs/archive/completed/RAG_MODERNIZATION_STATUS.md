> **Archived — implementation checkpoint complete.** The described RAG v2 runtime landed; retained component experiments are not an active delivery commitment. Use [RAG_MODERNIZATION.md](../../RAG_MODERNIZATION.md) for the runtime architecture.
