> **Archived — completed.** M1 through M3B are implemented. The active GitHub planning boundary is [G7](../../GITHUB_INTEGRATION_PHASE7_2026-08.md) and [MASTER_PLAN.md](../../MASTER_PLAN.md).
