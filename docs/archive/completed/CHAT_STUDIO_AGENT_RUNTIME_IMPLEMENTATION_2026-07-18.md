> **Archived — completed historical implementation record.** Later sandbox and durable-task work is tracked in [MASTER_PLAN.md](../../MASTER_PLAN.md).
...
The current design and operational reference is [Provider-aware search](../../PROVIDER_AWARE_SEARCH.md). User-facing behavior is documented in [Feature FAQ](../../Feature%20FAQ.md), and the component map is documented in the [Technical Reference](../../TECHNICAL_REFERENCE.md#provider-aware-current-information-routing).
