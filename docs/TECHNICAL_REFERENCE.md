<!--
  This is the detailed engineering reference for OmniLLM-Studio.
  For the product overview and quick start, see ../README.md.
-->

# OmniLLM-Studio Technical Reference

[← Back to the product overview](../README.md)

<p align="center">
  <img src="assets/banner.svg" alt="OmniLLM-Studio" width="100%"/>
</p>
...
<p align="center">
  <img src="assets/request-flow.svg" alt="Request lifecycle diagram" width="100%"/>
</p>
...
For automated cross-platform releases, use platform-native CI runners (CGO cross-compilation is not practical). See the [build scripts](#build-scripts) above for the supported platform and architecture combinations.
...
For a complete walk-through — kind cluster setup, BYO Secret patterns, SSE troubleshooting, backups, upgrades, and cloud-specific Ingress notes — see **[how_to_helm.md](how_to_helm.md)**.
